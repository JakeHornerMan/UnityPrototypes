...
namespace JH
{
    public class CameraHandler : MonoBehaviour
    {
        ...
        private void HandleCamerCollisions(float delta){
            ...
            cameraTransformPosition.z = Mathf.Lerp(cameraTransformPosition.z, targetPosition, delta/0.2f);
